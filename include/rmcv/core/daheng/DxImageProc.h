...
#ifndef RM_STANDARD2022_DXIMAGEPROC_H
#define RM_STANDARD2022_DXIMAGEPROC_H
...
typedef enum tagDX_PIXEL_COLOR_FILTER {
    NONE = 0, BAYERRG = 1, BAYERGB = 2, BAYERGR = 3, BAYERBG = 4
} DX_PIXEL_COLOR_FILTER;

/// image interpolation method
typedef enum tagDX_BAYER_CONVERT_TYPE {
    RAW2RGB_NEIGHBOUR = 0, RAW2RGB_ADAPTIVE = 1, RAW2RGB_NEIGHBOUR3 = 2
...
typedef enum DX_IMAGE_MIRROR_MODE {
    HORIZONTAL_MIRROR = 0, VERTICAL_MIRROR = 1
} DX_IMAGE_MIRROR_MODE;

/// RGB channel order
typedef enum DX_RGB_CHANNEL_ORDER {
    DX_ORDER_RGB = 0, DX_ORDER_BGR = 1
...
#endif //RM_STANDARD2022_DXIMAGEPROC_H
